import{o as C,c as N,e as D,r as G}from"./sanitize-Dk4qHRqk.js";import{g as M,f as k}from"./renderCell-D2QPO2EK.js";import{k as U,c as H,R as v}from"./keepAlive-By6PPzHl.js";import{I as t,g as P,t as Q}from"./icons-C5SiWFC8.js";import{a as j,g as f}from"./url-NB_mxKzZ.js";function W(l,c=130,h="neutral"){const m={resonant:{color:"5A2E00",bg:"FFF3DE"},dissonant:{color:"0A3558",bg:"EAF6FF"},neutral:{color:"1E2A36",bg:"F2F6FB"}},{color:r,bg:$}=m[h]||m.neutral;return`<img class="qr-image"
        src="https://api.qrserver.com/v1/create-qr-code/?size=${c}x${c}&color=${r}&bgcolor=${$}&data=${encodeURIComponent(l)}"
        width="${c}" height="${c}" />`}async function Y(l){const{roomId:c,token:h}=j();if(!c||!h){window.location.href=f()+"/index.html";return}const m=H(c);m.listen(),U(m);const r=N(c);if(await r.init(),!r.getState()){window.location.href=f()+"/index.html";return}function $(e,o){return`${f()}/${e}.html?room=${c}&token=${h}&team=${o}`}let i=!1,g=!1,q=!1,y=!1,E=new Set;function w(){const e=document.getElementById("fullscreenBtn");e&&(e.innerHTML=document.fullscreenElement?t.minimize:t.maximize)}function u(){const e=l.querySelector(".game__qr-hub");if(!e){i=!1,g=!1;return}const o=i||g;e.classList.toggle("is-open",o),e.classList.toggle("is-pinned",i)}function F(){i=!1,g=!1,u()}function T(e,o,d){const n=Q(o),{cells:_}=e,A=_.filter(a=>a.role==="resonant").length,B=_.filter(a=>a.role==="dissonant").length,I=_.filter(a=>a.role==="resonant"&&a.revealed).length,x=_.filter(a=>a.role==="dissonant"&&a.revealed).length,L=e.turn.guideLimit===null?n.turnRoleGuide:n.turnRoleWalker,O=[{team:"dissonant",role:"guide",label:n.guide,presenceRole:v.GUIDE_DISSONANT},{team:"dissonant",role:"walker",label:n.dreamwalker,presenceRole:v.WALKER_DISSONANT},{team:"resonant",role:"guide",label:n.guide,presenceRole:v.GUIDE_RESONANT},{team:"resonant",role:"walker",label:n.dreamwalker,presenceRole:v.WALKER_RESONANT}];document.body.className=`team-${e.turn.team}`;const S=new Set(_.map((a,s)=>a.revealed?s:-1).filter(a=>a>=0));l.innerHTML=`
            ...
            <footer class="screen-footer game__footer">
                <div class="game__score">
                    ...
                    <span class="game__score-center ${e.gameOver?"game__score-center--finished":""}">
                        ...
                        <span class="game__score-center-text">${e.gameOver?n.gameFinished:P(e.turn.team,o)}</span>
                    </span>
        ...
        `,l.querySelectorAll(".game .grid .cell").forEach((a,s)=>{y&&(!S.has(s)||E.has(s)||a.classList.add("cell--reveal-anim"))}),E=S,y=!0,document.getElementById("backBtn").addEventListener("click",()=>{window.location.href=f()+"/index.html"}),document.getElementById("fullscreenBtn").addEventListener("click",()=>{var a,s,R;document.fullscreenElement?(R=document.exitFullscreen)==null||R.call(document):(s=(a=document.documentElement).requestFullscreen)==null||s.call(a)}),w();const p=l.querySelector(".game__qr-hit");p==null||p.addEventListener("mouseenter",()=>{var a;(a=r.getState())!=null&&a.turnTransition||(g=!0,u())}),p==null||p.addEventListener("mouseleave",()=>{var a;(a=r.getState())!=null&&a.turnTransition||(g=!1,u())}),u(),requestAnimationFrame(()=>k(l))}function b(){const e=r.getState(),o=r.getLanguage(),d=m.getPresenceState();if(!e){window.location.href=f()+"/index.html";return}if(e.phase==="lobby"){r.startGame().catch(n=>{console.error("Failed to start game:",n)});return}T(e,o,d)}r.subscribe(b),m.onChange(b),C(()=>k(l)),q||(document.addEventListener("fullscreenchange",w),q=!0),l.addEventListener("click",e=>{var d;if((d=r.getState())!=null&&d.turnTransition)return;if(e.target.closest(".game__qr-hit")){e.preventDefault(),i=!i,u();return}i&&(i=!1,u())}),document.addEventListener("keydown",e=>{e.key==="Escape"&&(i||g)&&F()}),b()}export{Y as initGame};
