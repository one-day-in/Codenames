import{t as m,D as L,g as E}from"./i18n-BSQgICzt.js";import{k,c as q,a as y,A as h,g as N,R as g}from"./keepAlive-DqUUpVTB.js";import{f as A}from"./fitText-DhGiXhRH.js";function S(){const t=new URLSearchParams(window.location.search);return{roomId:t.get("room"),token:t.get("token")}}function d(){const{origin:t,pathname:s}=window.location;return t+s.split("?")[0].replace(/\/[^/]*$/,"")}function G(t,s=130){return`<img class="qr-image"
