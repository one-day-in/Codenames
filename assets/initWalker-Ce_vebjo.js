import{g as y,e as T,r as h,a as L,b as C,o as S,h as M,i as A,j as O}from"./revealedCells-CL4RmJ5T.js";import{b as x,f as E,I as p,t as k,D as $}from"./url-DAL9jQbt.js";import{i as G,b as I}from"./initGuestPage-Cfrxz3C7.js";import"./entry-BDlMYCOj.js";import"./roomRepository-CD0Cuu1e.js";function B({state:e,lang:s,team:d,syncStatus:r}){const t=k(s),i=e.turn,o=i.team===d,v=i.guideLimit!==null,l=o&&v&&!e.gameOver&&!e.turnTransition,u=v?Math.max((i.guideLimit??0)-(i.dreamwalkerMoves??0),0):0,a=x(d,s),m=l?`${t.dreamwalker}: <span class="walker__moves-value">${E(u,s)}</span>`:`${t.dreamwalker}: ${p.eyeClosed}`;return`
