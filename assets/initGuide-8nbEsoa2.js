import{k as S,e as w,r as A,a as G,b as B,o as H,h as N,i as k,l as M}from"./revealedCells-dP0TpZDF.js";import{b as O,I as E,t as f,D as y,n as I}from"./url-Qg2x4s1h.js";import{i as x,b as R}from"./initGuestPage-nDKbcvyT.js";import"./entry-DWqnp-B9.js";import"./roomRepository-DwKmHnBd.js";function W({state:i,lang:s,team:r,syncStatus:d,maxHintButtons:u,teamEffects:t}){const n=f(s),c=i.turn,_=c.team===r,m=c.guideLimit!==null,e=_&&!m&&!i.gameOver&&!i.turnTransition,g=t.allowTwoWordClue,a=t.forcedGuideLimit,o=t.hideEnemyColors,l=t.hideNightmare,T=O(r,s),b=e?`${n.guide}: ${n.chooseLimit}`:`${n.guide}: ${E.eyeClosed}`,p=[e&&a===1?n.guideForcedOneMove:null,e&&g?n.guideTwoWordClue:null,o?n.guideBlurActive:null,l?n.guideNightmareHidden:null].filter(Boolean),L=p.length?`<div class="guide__meta ${e?"guide__meta--active":"guide__meta--muted"}">${p.join(" • ")}</div>`:"",C=Array.from({length:u},($,h)=>{const v=h+1;return`
            <button
