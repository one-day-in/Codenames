import{c as h,g as _,a as u,f as b}from"./fullscreen-CctTKBtY.js";import{g as $}from"./renderCell-B3ZMaWK7.js";function m(){const r=document.createElement("footer");return r.className="app-footer",r.appendChild(h()),r}async function g(r){const n=_(),s=u(n);await s.init();function l(){const{origin:e,pathname:a}=window.location,o=a.split("?")[0].replace(/\/[^/]*$/,"")||"";return e+o}function t(e,a=120){return`<img class="qr-image" src="https://api.qrserver.com/v1/create-qr-code/?size=${a}x${a}&data=${encodeURIComponent(e)}" width="${a}" height="${a}" />`}function c(){document.body.classList.remove("team-red","team-blue");const a=`${l()}/mini.html?room=${n}`;r.innerHTML=`
      <div class="app">
