import{C as F,r as ee,a as ne,m as ce,e as te,g as de,c as ue,p as W,d as me,i as ge,o as _e,f as pe,n as re,j as Y,k as Z,q as fe,l as ve}from"./turnTransitionDismiss-UUgHzLH0.js";import{t as H,e as O,I as M,f as ke,h as ye,k as $e,D,n as we}from"./roomRepository-BzPr1MxX.js";import"./entry-DeqvSbsz.js";function he(e){const n=H(e);let c=[];function a(){const i=Math.min(window.innerWidth,window.innerHeight),t=Math.max(window.innerWidth,window.innerHeight);return window.matchMedia("(pointer: coarse)").matches&&i<=768&&t<=1024}async function g(){var i;if(a())try{(i=screen.orientation)!=null&&i.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let i=document.getElementById("orientation-guard");return i||(i=document.createElement("div"),i.id="orientation-guard",i.className="orientation-guard",i.setAttribute("aria-live","polite"),i.innerHTML=`
