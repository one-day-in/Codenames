import{C as U,r as ae,a as se,q as ce,s as de,g as ue,c as He,p as O,d as Be,i as Pe,o as Ee,f as xe,t as me,n as Me,l as I,k as Ge,m as Oe,j as Ie}from"./gridPatch-CPzuiiEx.js";import{t as B,e as z,I as A,f as Ae,h as Ne,k as We,D as K,m as qe,n as Fe,o as ie}from"./roomRepository-CIM5PE7W.js";import{r as je}from"./entry-C5QaYIsd.js";function ze(e){const n=B(e);let m=[];function o(){const a=Math.min(window.innerWidth,window.innerHeight),l=Math.max(window.innerWidth,window.innerHeight);return window.matchMedia("(pointer: coarse)").matches&&a<=768&&l<=1024}async function p(){var a;if(o())try{(a=screen.orientation)!=null&&a.lock&&await screen.orientation.lock("portrait")}catch{}}function s(){let a=document.getElementById("orientation-guard");return a||(a=document.createElement("div"),a.id="orientation-guard",a.className="orientation-guard",a.setAttribute("aria-live","polite"),a.innerHTML=`
