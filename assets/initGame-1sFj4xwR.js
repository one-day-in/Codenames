import{o as v,c as _}from"./resize-Cd5pde_8.js";import{g as w,f as m}from"./renderCell-j9Yfrae9.js";import{a as $,g as a,G as E,t as B,D as x}from"./url-oOUZ7you.js";import{b as y}from"./auth-Cy9wPIq3.js";import{I as o}from"./icons-DY9imHO6.js";async function T(i){const{roomId:r,token:u}=$();if(!r||!u){window.location.href=a()+"/index.html";return}i.innerHTML=`
        <div class="app">
            <div class="lobby-screen">
                <h1 class="lobby__title">${E}</h1>
                <p>${B(x).loading}</p>
            </div>
        ...
        `,document.getElementById("backBtn").addEventListener("click",()=>{window.location.href=a()+"/index.html"}),document.getElementById("profileBtn").addEventListener("click",async()=>{await y(),window.location.href=a()+"/index.html"}),document.getElementById("fullscreenBtn").addEventListener("click",()=>{var e,c,d;document.fullscreenElement?(d=document.exitFullscreen)==null||d.call(document):(c=(e=document.documentElement).requestFullscreen)==null||c.call(e)}),requestAnimationFrame(()=>m(i))}function l(){const n=t.getState();if(t.getLanguage(),!n){window.location.href=a()+"/index.html";return}if(n.phase==="lobby"){t.startGame();return}f(n)}t.subscribe(l),v(()=>m(i)),l()}export{T as initGame};
