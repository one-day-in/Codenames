import{C as j,r as Y,a as Z,m as le,e as ee,g as se,c as ce,p as F,d as de,i as ue,o as me,f as ge,n as ne,j as Q,k as X,q as _e,l as pe}from"./turnTransitionDismiss-Blp-tebh.js";import{t as H,e as O,I as M,f as fe,h as ve,k as ke,D as W,n as ye}from"./roomRepository-DDSKDQUG.js";import"./entry-GGmdiMZe.js";function $e(e){const n=H(e);let s=[];function l(){const i=Math.min(window.innerWidth,window.innerHeight),t=Math.max(window.innerWidth,window.innerHeight);return window.matchMedia("(pointer: coarse)").matches&&i<=768&&t<=1024}async function m(){var i;if(l())try{(i=screen.orientation)!=null&&i.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let i=document.getElementById("orientation-guard");return i||(i=document.createElement("div"),i.id="orientation-guard",i.className="orientation-guard",i.setAttribute("aria-live","polite"),i.innerHTML=`
