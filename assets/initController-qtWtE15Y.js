import{C as I,m as ee,e as V,r as K,a as Q,g as ne,c as te,p as F,d as re,i as ie,o as oe,f as ae,n as B,j as z,k as D,q as le,l as se}from"./turnTransitionDismiss-zQ_c580Z.js";import{t as R,e as G,I as x,f as ce,h as de,k as ue,D as J,n as me}from"./roomRepository-B6shp1eI.js";import"./entry-BDqnNpt6.js";function ge(e){const n=R(e);let l=[];function s(){const i=Math.min(window.innerWidth,window.innerHeight),o=Math.max(window.innerWidth,window.innerHeight);return window.matchMedia("(pointer: coarse)").matches&&i<=768&&o<=1024}async function m(){var i;if(s())try{(i=screen.orientation)!=null&&i.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let i=document.getElementById("orientation-guard");return i||(i=document.createElement("div"),i.id="orientation-guard",i.className="orientation-guard",i.setAttribute("aria-live","polite"),i.innerHTML=`
