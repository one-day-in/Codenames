import{t as v,b as k,s as b,D as f,d as L}from"./url-BRusC3Pl.js";import{k as w,c as E,a as y,R as g}from"./sanitize-BAG_KHiZ.js";function _(a){const t=v(a);let o=[];async function i(){var e;try{(e=screen.orientation)!=null&&e.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let e=document.getElementById("orientation-guard");return e||(e=document.createElement("div"),e.id="orientation-guard",e.className="orientation-guard",e.setAttribute("aria-live","polite"),e.innerHTML=`
