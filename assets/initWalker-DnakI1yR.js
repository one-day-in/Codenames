import{o as E,g as S,e as G,r as H,f as I}from"./sanitize-CCtgZlBF.js";import{t as m,D as f,c as O,b as $,g as x,f as M,I as g}from"./icons-wP800kuJ.js";import{i as N}from"./initGuestPage-d4AEqDG1.js";import"./keepAlive-00b6PTff.js";async function W(t){const v=await N(t,{roleType:"walker",invalidParamsHtml:`<div class="error-screen">
...
`,"<br>")}</p>
        ...
        </div>`}function p(e,r){o=!1,w=new Set;const a=m(r),s=e.winner===c;t.innerHTML=`
            ...
            </div>`,document.getElementById("newGameBtn").addEventListener("click",async()=>{await l.resetGame(),window.location.href=x()+"/index.html"})}function y(e,r){var k;const a=m(r),s=e.turn,L=s.team===c,T=s.guideLimit!==null,i=L&&T&&!e.gameOver&&!e.turnTransition,C=$(c,r),_=new Set(e.cells.map((n,d)=>n.revealed?d:-1).filter(n=>n>=0)),A=i?`${a.dreamwalker}: ${M(s.guideLimit,r)}`:`${a.dreamwalker}: ${g.eyeClosed}`,B=i?"walker__status walker__status--active":"walker__status walker__status--muted";document.body.classList.remove("team-resonant","team-dissonant"),document.body.classList.add(`team-${c}`),t.innerHTML=`
