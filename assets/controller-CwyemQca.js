import{b as g,o as f,a as $,f as L}from"./fullscreen-DPszhWwL.js";import{g as T}from"./renderCell-B3ZMaWK7.js";async function w(n){const r=new URLSearchParams(window.location.search).get("team"),i=g();if(!i||!r||r!=="red"&&r!=="blue"){n.innerHTML=`
