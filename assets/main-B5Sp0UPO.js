import{c as h,g as u,a as _,f as $}from"./fullscreen-B6UZMS3G.js";import{g as b}from"./renderCell-B3ZMaWK7.js";function p(){const r=document.createElement("footer");return r.className="app-footer",r.appendChild(h()),r}async function g(r){const n=u(),t=_(n);await t.init();function c(){const{origin:e,pathname:a}=window.location,o=a.split("?")[0].replace(/\/[^/]*$/,"")||"";return e+o}function s(e,a=120){return`<img class="qr-image" src="https://api.qrserver.com/v1/create-qr-code/?size=${a}x${a}&data=${encodeURIComponent(e)}" width="${a}" height="${a}" />`}function d(){document.body.classList.remove("team-red","team-blue");const a=`${c()}/mini.html?room=${n}`;r.innerHTML=`
      <div class="app">
