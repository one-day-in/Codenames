import{t as v,b,s as k,D as f,d as w}from"./url-DrpWMjE3.js";import{a as L,c as y,b as E,R as g}from"./syncIndicator-DNY5rdPG.js";function _(a){const t=v(a);let o=[];async function i(){var e;try{(e=screen.orientation)!=null&&e.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let e=document.getElementById("orientation-guard");return e||(e=document.createElement("div"),e.id="orientation-guard",e.className="orientation-guard",e.setAttribute("aria-live","polite"),e.innerHTML=`
...
`,"<br>")}</p>
            ...
            </div>`,await new Promise(p=>{document.getElementById("forceJoinBtn").addEventListener("click",p,{once:!0})})),u.join(c),_(s),document.body.classList.add(`team-${n}`);const m=E(i);return await m.init(),await L({presence:u,store:m,role:c}),{presence:u,store:m,team:n,roomId:i}}export{A as i};
